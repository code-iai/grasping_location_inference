...
if __name__ == "__main__":
    ...
    model.add_predictor('cup.n.01', 'TOP', 'LEFT-SIDE', 'BOTTOM', 'pr2_left_arm')
    model.add_predictor('cup.n.01', 'TOP', 'RIGHT-SIDE', 'BOTTOM', 'pr2_left_arm')
    model.add_predictor('cup.n.01', 'TOP', 'BACK', 'BOTTOM', 'pr2_left_arm')
    result = model.get_probability_distribution_for_grid()
